...
public class MessageConstant {
    ...
    public static final String QUERY_CHECKGROUPCHECKITEM_SUCCESS = "查询检查组项成功";
    public static final String QUERY_CHECKGROUPCHECKITEM_FAIL = "查询检查组项失败";
    public static final String DELETE_ROLE_SUCCESS = "用户删除成功";
    public static final String DELETE_ROLE_FAIL = "用户删除失败";
    public static final String QUERY_ROLE_SUCCESS = "用户查询成功";
    public static final String QUERY_ROLE_FAIL = "用户查询失败";
    public static final String EDIT_ROLE_SUCCESS = "编辑用户成功";
    public static final String EDIT_ROLE_FAIL = "编辑用户失败";
    ...
    public static final String ADD_ROLE_SUCCESS = "角色添加成功";
    public static final String ADD_ROLE_FAIL = "角色添加失败";
}
